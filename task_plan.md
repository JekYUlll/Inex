...
- [ ] 对每个候选 VSIX，使用独立的真实规模 Markdown Git 仓库副本完成 `import-repository` 全流程（含隐藏已跟踪文件、307+ Markdown、附件与至少一个 25 MiB 图片），并验证发布、锁定结构、fresh unlock 与无明文残留；fixture、dry-run 或只验证 bundled binary 不得替代此门禁
- **Status:** in_progress
