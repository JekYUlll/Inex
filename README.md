...
| Packaging | Release-tool tests pass 19/19, `actionlint` and pedantic/all-features Clippy pass, and independent release-tool code review is GO. A local system-GCC Linux x64 repackage passes strict archive/native-dependency audit plus VS Code 1.125.0 CLI install/bundled-sidecar smoke | A post-hardening clean-source double build, native Windows/arm64 workflow runs, signatures, publication, and independent legal review remain pending |
