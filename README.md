...
|---------|------------------|--------------------|
| Rust core, CLI, daemon, import, and Git | Linux workspace tests and strict static gates pass; Windows GNU compiles and substantial Wine tests pass | Native Windows/MSVC filesystem, rename/modify merge, and crash/power-loss evidence is still pending |
